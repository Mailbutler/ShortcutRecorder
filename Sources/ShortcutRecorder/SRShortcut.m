...
+ (instancetype)shortcutWithEvent:(NSEvent *)aKeyboardEvent ignoringCharacters:(BOOL)aShouldIgnoreCharacters
{
    ...
    {
        os_log_error(OS_LOG_DEFAULT, "#Error aKeyboardEvent must be either NSEventMaskKeyUp, NSEventMaskKeyDown or NSEventMaskFlagsChanged, but got %{public}lu", aKeyboardEvent.type);
        return nil;
    }
