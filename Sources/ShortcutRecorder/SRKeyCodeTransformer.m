                             ...
                             usingCache:(BOOL)anIsUsingCache
{
    ...
    @synchronized (self)
    {
        ...
        if (error != noErr)
        {
            os_log_error(OS_LOG_DEFAULT, "#Error Unable to translate keyCode %{public}hu and modifierFlags %{public}lu: %{public}d",
                           aKeyCode,
        ...
        {
            os_log_debug(OS_LOG_DEFAULT, "#Error No translation exists for keyCode %{public}hu and modifierFlags %{public}lu",
                           aKeyCode,
                           anImplicitModifierFlags);
            return nil;
        }
